...
/datum/ert/usa
	roles = list(/datum/antagonist/ert/usa)
	leader_role = /datum/antagonist/ert/usa/leader
	rename_team = "USA Squad"
	mission = "Stop the anomaly."
	polldesc = "an trained force of anomaly-stopping agents"
