...
/obj/item/gun/ballistic/revolver/syndicate/usa
	name = "\improper USA Suppressor"
	desc = "A syndicate revolver with the word 'USA' slapped onto it, this should be fine!"
